...
class Ui_Form_register(object):
    def setupUi_register(self, Form):
...
"border-bottom-right-radius:50px;")
        ...
        self.label_4.setGeometry(QtCore.QRect(1730, 389, 280, 81))
        font = QtGui.QFont()
        ...
        self.UsrNameEdit = QtWidgets.QLineEdit(self.widget)
        self.UsrNameEdit.setGeometry(QtCore.QRect(1559, 514, 551, 91))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.UsrNameEdit.setFont(font)
        self.UsrNameEdit.setStyleSheet("background-color:rgba(0,0,0,0);\n"
"border:none;\n"
...
"")
        ...
        self.passwordEdit.setGeometry(QtCore.QRect(1559, 650, 551, 81))
        font = QtGui.QFont()
        font.setPointSize(18)
...
"")
        ...
        self.RegisterBtn.setGeometry(QtCore.QRect(1650, 1010, 401, 121))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_5.setGeometry(QtCore.QRect(1560, 890, 271, 41))
        font = QtGui.QFont()
...
"")
        ...
        self.ReentrPasswordEdit = QtWidgets.QLineEdit(self.widget)
        self.ReentrPasswordEdit.setGeometry(QtCore.QRect(1560, 790, 551, 81))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.ReentrPasswordEdit.setFont(font)
        self.ReentrPasswordEdit.setStyleSheet("background-color:rgba(0,0,0,0);\n"
"border:none;\n"
"border-bottom: 2px solid rgba(46,82,101,200);\n"
"color:rgba(0,0,0,240);\n"
"padding-bottom:7px;\n"
"\n"
"")
        self.ReentrPasswordEdit.setObjectName("ReentrPasswordEdit")
    ...
    def retranslateUi(self, Form):
        ...
        self.UsrNameEdit.setPlaceholderText(_translate("Form", "User Name"))
        self.passwordEdit.setPlaceholderText(_translate("Form", "Password"))
        self.RegisterBtn.setText(_translate("Form", "Register"))
        self.label_5.setText(_translate("Form", " "))
        self.ReentrPasswordEdit.setPlaceholderText(_translate("Form", "Re Enter Password"))
import res
'''
